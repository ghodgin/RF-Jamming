...
def streamlit_app():
    ...
    st.write('- Active scan jamming techniques are as difficult to identify and classify as passive scan techniques.')
    st.write('### Alternate Hypothesis')
    st.write('- Active scan jamming techniques are easier to identify and classify than passive scan techniques.')
    st.write('## The Data')
